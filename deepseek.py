# Hikka module: DeepSeek Chat with memory (dict-based, Heroku-ready)
# by neko helper :3
...
class DeepSeekMod(loader.Module):
    """DeepSeek API с памятью и системным промтом (dict-based для Heroku)"""
